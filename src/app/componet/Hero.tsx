    ...
    return (
        ...
        <div className='pl-10'>
          ...
          <div className=' gap-4 grid lg:grid-cols-4
            sm:grid-cols-2 mb-10 text-center'>
...
<div className='border-blue-400 border-x-4 border-y-4 hover:shadow-2xl hover:shadow-black text-cyan-600 rounded-lg text-center mr-5 ml-5 '>
                    <Link href="https://soap2day.rs/movie/watch-the-last-stop-in-yuma-county-full-108958"> <Image src="/1.png" alt='1' width={200} height={200} className='hover:opacity-80 w-full '></Image></Link>
                    <Link href="https://soap2day.rs/movie/watch-the-last-stop-in-yuma-county-full-108958"> <h1>The last Stop</h1></Link>
                    <Link href="https://soap2day.rs/movie/watch-the-last-stop-in-yuma-county-full-108958"><h1>In yuma Country</h1></Link>
            ...
            <div className='border-blue-400 border-x-4 border-y-4 hover:shadow-2xl hover:shadow-black text-cyan-600 rounded-lg text-center mr-5 ml-5 '>
               <Link href="https://soap2day.rs/movie/watch-may-the-12th-be-with-you-full-108934"> <Image src="/6.png" alt='6' width={200} height={200} className='hover:opacity-80 w-full'></Image></Link>
                <Link href="https://soap2day.rs/movie/watch-may-the-12th-be-with-you-full-108934"><h1 >MAY THE 12TH BE</h1></Link>
                <Link href="https://soap2day.rs/movie/watch-may-the-12th-be-with-you-full-108934"><h1>WITH YOU</h1></Link>
        ...
        <div className='text-blue-900 font-extrabold text-2xl    bg-blue-300 mt-6 '>
                <h1>Old Movies</h1>
            </div>
            <div className=' gap-4  grid lg:grid-cols-4
            sm:grid-cols-2 mb-10'>
                ...
                <div className='border-blue-400 border-x-4 border-y-4 hover:shadow-2xl hover:shadow-black text-cyan-600 rounded-lg text-center mr-5 ml-5 '>
                    <Link href="https://soap2day.rs/movie/watch-hotel-transylvania-2-full-19181"><Image src="/13.png" alt='13' width={180} height={200} className='hover:opacity-80 w-full'></Image></Link>
